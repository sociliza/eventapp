...
class BusinessesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create business" do
    assert_difference('Business.count') do
      post businesses_url, params: { business: { company_name: @business.company_name, slug: @business.slug } }
    end
  ...
  test "should update business" do
    patch business_url(@business), params: { business: { company_name: @business.company_name, slug: @business.slug } }
